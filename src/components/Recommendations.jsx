    ...
    <>
      <section id="recommendations" className="d-flex flex-column justify-content-center py-5">
        ...
        <div
          ...
          className="carousel slide carousel-fade d-flex flex-column align-items-center"
        ...
        >
          ...
          <div className="carousel-inner w-50">
            <div className="carousel-item active card bg-dark text-light border-info py-3 px-4">
